...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Okt 2021 pada 05.52
...
(5, 'ADRIELEDGARD123', 'ADRIELEDGARD12345@GMAIL.COM', '0878612121', '58b4e38f66bcdb546380845d6af27187', 'CUST', 1, '8dppa1aa94atv', 0, 50),
...
(12, '2021-10-28', 5, 100, 0, 50, 50, 'Claim voucher', 10);
...
(87, 39, 70, '2021-10-28', '2021-10-28', 'RP', 1);
...
INSERT INTO `voucher` (`Id_voucher`, `Voucher_name`, `Voucher_type`, `Discount`, `Point`, `Joinpromo`, `Status`) VALUES
(10, 'VOUCHER 1', 1, 50000, 50, 1, 1),
(11, 'VOUCHER 2', 2, 900000, 10, 0, 1),
(12, 'VOUCHER 3', 2, 90000, 30, 0, 1),
(14, 'VOUCHER 4', 2, 18000, 15, 0, 1),
(15, 'VOUCHER 5', 2, 85000, 25, 0, 1),
(16, 'VOUCHER 6', 2, 5000, 20, 0, 1),
(17, 'VOUCHER KEMERDEKAAN', 3, 35000, 15, 0, 1),
(18, 'VOUCHER MANTAP', 1, 50000, 150, 1, 1);
...
--
ALTER TABLE `point_card`
  MODIFY `Id_point_card` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `voucher`
  MODIFY `Id_voucher` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT untuk tabel `voucher_member`
--
ALTER TABLE `voucher_member`
  MODIFY `Id_voucher_member` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
