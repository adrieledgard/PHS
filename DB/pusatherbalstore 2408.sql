...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Agu 2021 pada 20.11
...
--
ALTER TABLE `affiliate`
  MODIFY `Id_affiliate` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `product_sub_category`
  MODIFY `Id_product_sub_category` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
