...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Jun 2021 pada 22.35
...
INSERT INTO `receive_detail` (`No_receive_detail`, `No_receive`, `Id_product`, `Id_variation`, `No_purchase_detail`, `Qty`) VALUES
(14, 'INV-RO-300621-0001', 38, 57, 3, 50),
(15, 'INV-RO-300621-0001', 40, 40, 4, 3),
(16, 'INV-RO-300621-0002', 38, 57, 3, 20);
...
('INV-RO-300621-0001', 'INV-P-090621-0001', '30/06/2021', 6, 1),
('INV-RO-300621-0002', 'INV-P-090621-0001', '30/06/2021', 17, 1);
...
--
ALTER TABLE `product_sub_category`
  MODIFY `Id_product_sub_category` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `receive_detail`
  MODIFY `No_receive_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
