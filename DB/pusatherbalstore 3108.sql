...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Agu 2021 pada 19.31
...
(29, 38, 57, '2021-08-15', '2021-08-18', '%', 1),
(30, 38, 57, '2021-08-19', '2021-08-19', '%', 1),
(31, 38, 57, '2021-08-21', '2021-08-22', '%', 1),
...
--
ALTER TABLE `promo_detail`
  MODIFY `Id_promo_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT untuk tabel `promo_header`
--
ALTER TABLE `promo_header`
  MODIFY `Id_promo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
