...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Sep 2021 pada 19.00
...
(10, 'DINA', 'DINA@GMAIL.COM', '087188085565', '58b4e38f66bcdb546380845d6af27187', 'CUST', 1),
...
('INV-RO-240921-0001', 'INV-P-040821-0001', '2021-09-24', 14, 'INV 67212121', 2, 0),
...
--
ALTER TABLE `product_sub_category`
  MODIFY `Id_product_sub_category` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;

--
-- AUTO_INCREMENT untuk tabel `promo_detail`
--
ALTER TABLE `promo_detail`
  MODIFY `Id_promo_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT untuk tabel `promo_header`
--
ALTER TABLE `promo_header`
  MODIFY `Id_promo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
...
--
ALTER TABLE `variation_product`
  MODIFY `Id_variation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
