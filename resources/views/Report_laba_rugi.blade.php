...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-6">
      <div class="card">
        <div class="card-body">
          {{Form::open(array('url'=>'laba_rugi','method'=>'get','class'=>''))}}
          <div class="row ">
          ...
          <a href="{{url('laba_rugi_print?filter=' . request()->input('filter') . "&filter_".request()->input('filter'). "=" . request()->input("filter_". request()->input('filter')))}}" class="btn btn-warning btn-sm"  style="margin-left:10px;" target="_blank">Print</a>    
          @else
          <a href="{{url('laba_rugi_print')}}" class="btn btn-warning btn-sm" style="margin-left:10px;"  target="_blank">Print</a>
          @endif
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-body">
          Profit : Rp. {{number_format($total_keuntungan)}}
        </div>
      </div>
    </div>
  </div>
      ...
      <tbody id="">
        @foreach ($cust_orders as $order)
            <tr>
              ...
              <td>Rp. {{ number_format($order->order_profit)}}</td>
            </tr>
        @endforeach
      </tbody>
    </table>
        ...
        $(".table-body-rincian-item-order").append(`
            <tr>
              <td>
                ...
                <td>
                    `+formatter.format(detail.keuntungan_per_item)+`
                </td>
                <td>
                    `+formatter.format(detail.keuntungan_item)+`
                </td>
            </tr>
        `)
    });
