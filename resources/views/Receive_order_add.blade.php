            ...
            <div class="col-md-12">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {{ Form::button('<i class="fa fa-mouse-pointer" aria-hidden="true"></i> Select',['class'=>'btn btn-warning btn-sm','onClick'=>"select_product('$data->Id_product')"]) }}
                  </td>
                </tr>
                @endforeach
              </tbody>
...
function invtosession(noinv)
{
 
  $.get(myurl + '/session_receive_select',
    {noinv:noinv},
    function(result){
      window.location = myurl + "/Receive_order_add_select/";
    });
}
  ...
  function choose_supplier(idsup)
  {
    ...
    $.get(myurl + '/show_supplier_receive_order',
    {idsup: idsup},
    function(result){
