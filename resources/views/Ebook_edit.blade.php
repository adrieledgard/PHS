  ...
  <div class="container-fluid">
      ...
      <div class="jumbotron">
       {{Form::open(array('url'=>'master_ebook/update/' . $ebook->Id_ebook,'method'=>'post','class'=>'row g-3', 'files' => true))}}
        ...
        <div class="col-md-12">
          @php
              $template1 = ($ebook->Id_template == 1) ? true : false;
              $template2 = ($ebook->Id_template == 2) ? true : false;
              $template3 = ($ebook->Id_template == 3) ? true : false;
          @endphp
          {{ Form::label('Template :','') }}
          {{Form::radio('id_template', '1', $template1)}} Template 1
          {{Form::radio('id_template', '2', $template2)}} Template 2
          {{Form::radio('id_template', '3', $template3)}} Template 3
          <br>
