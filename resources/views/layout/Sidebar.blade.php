...
if(session()->get('userlogin')->Role =="ADMIN")
{
  ?>
    ...
    <li class="nav-item @yield('menu_report')">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="{!! url('pembelian'); !!}" class="nav-link  @yield('pembelian_report_atv')">
            <i class="far fa-circle nav-icon"></i>
            <p>Pembelian</p>
          </a>
        </li>
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="{!! url('omzet_affiliator'); !!}" class="nav-link  @yield('omzet_affiliator_report_atv')">
            <i class="far fa-circle nav-icon"></i>
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="{!! url('penukaran_point_member'); !!}" class="nav-link  @yield('penukaran_point_report_atv')">
            <i class="far fa-circle nav-icon"></i>
            <p>Penukaran Point Member</p>
          </a>
        </li>
