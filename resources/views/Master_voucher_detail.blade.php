...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Edit/Detail Voucher</li>
@endsection
...
@section('Content')
  <div class="container-fluid">
    ...
    {{-- <form class="" method='post' action='edit_voucher'> --}}
  {{Form::open(array('url'=>'edit_voucher','method'=>'post'))}}
    <div class="row">
      <div class="col-md-8">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-12">
                ...
                {{ Form::hidden('txt_id_voucher', $dtvoucher[0]['Id_voucher'], ['class'=>'form-control']) }}
                {{ Form::text('txt_voucher_name', $dtvoucher[0]['Voucher_name'], ['class'=>'form-control']) }}
    ...
    <div class="jumbotron">
      ...
      <div class="row">
         ...
         <div class="col-md-3">
          <div class="list-group" id="list-tab" role="tablist">
            <?php
              ...
              else if($dtvoucher[0]['Voucher_type']==2)
              {
                ?>
                  <a class="list-group-item list-group-item-action" id="list-1-list" data-bs-toggle="list" href="#list-1" role="tab" aria-controls="list-1" onclick="Type_voucher(1)">Discount All Product</a>
                  <a class="list-group-item list-group-item-action active" id="list-2-list" data-bs-toggle="list" href="#list-2" role="tab" aria-controls="list-2" onclick="Type_voucher(2)">Discount Selected Product</a>
                  <a class="list-group-item list-group-item-action " id="list-3-list" data-bs-toggle="list" href="#list-3" role="tab" aria-controls="list-3" onclick="Type_voucher(3)"> Discount Shipping Cost</a>
                <?php
              }
              else if($dtvoucher[0]['Voucher_type']==3)
              {
                ?>
                  <a class="list-group-item list-group-item-action" id="list-1-list" data-bs-toggle="list" href="#list-1" role="tab" aria-controls="list-1" onclick="Type_voucher(1)">Discount All Product</a>
                  <a class="list-group-item list-group-item-action" id="list-2-list" data-bs-toggle="list" href="#list-2" role="tab" aria-controls="list-2" onclick="Type_voucher(2)">Discount Selected Product</a>
                  <a class="list-group-item list-group-item-action active " id="list-3-list" data-bs-toggle="list" href="#list-3" role="tab" aria-controls="list-3" onclick="Type_voucher(3)"> Discount Shipping Cost</a>
                <?php
              }
        ...
        <div class="col-md-9">
          <div class="row">
            <div class="col-md-6">
              {{ Form::label('Discount:','') }}
              {{ Form::number('txt_discount', $dtvoucher[0]['Discount'], ['class'=>'form-control','id'=>'txt_discount']) }}
            </div>
            <br><br><br><br>
          </div>
          ...
          <div class="tab-content" id="nav-tabContent">
            ...
            <?php
              ...
              else if($dtvoucher[0]['Voucher_type']==2)
              {
                ?>
                  {{-- ------1 --}}
                  <div class="tab-pane fade bootstrap-tagsinput" id="list-1" role="tabpanel" aria-labelledby="list-1-list">
                
                  </div>


                  {{-- ------2 --}}
                  <div class="tab-pane fade show active" id="list-2" role="tabpanel" aria-labelledby="list-2-list">
                    <div class="row">
              ...
              else if($dtvoucher[0]['Voucher_type']==3)
              {
                ?>
                  ...
                  {{-- ------3 --}}
                  <div class="tab-pane fade show active" id="list-3" role="tabpanel" aria-labelledby="list-3-list">
      ...
      <div class="row">
        <div class="col-md-2">
          ...
          {{ Form::number('txt_point', $dtvoucher[0]['Point'], ['class'=>'form-control']) }}
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-2">
          ...
          {{ Form::select('select_promo', ['No Join','Join'], $dtvoucher[0]['Joinpromo'], [ 'class'=>'form-control', 'id'=>'select_promo' ]) }}
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="input-group date" id="reservationdate" data-target-input="nearest" onchange="clickdate()">
            ...
            <?php
              $sementara= $dtvoucher[0]['Redeem_due_date'];
              $tglbenar = $sementara[8].$sementara[9]."/".$sementara[5].$sementara[6]."/".$sementara[0].$sementara[1].$sementara[2].$sementara[3];

            ?>
            <i>Redeem due date before : {{$tglbenar}}</i>
    ...
    <div class="modal-footer">
      ...
      {{ Form::submit('Update', ['name'=>'edit_voucher', 'class'=>'btn btn-primary']) }}

      <button class="btn btn-danger"><a href="{!!url('master_voucher')!!}" style="color: white">Cancel</a></button>
