...
<div class="ooef">
   ...
   <script>
    ...
    try {
     ...
     ooe('setup', 'redirect', 'https://pusatherbal.orderonline.id');
     ooe('init', 'pusatherbal', 'super-gf-asam-lambung-3', '61289cc168e4c0206a0f3ca7', 'oo-embed-form-super-gf-asam-lambung-3-3801', {"mode":"page","action":"Klik untuk pemesanan","title":"Form Pemesanan","triggerPixel":false,"triggerGtm":false});
     if (!window.jQuery) {
      !function(w, d, e, v, id, t, s) {
      if (d.getElementById(id)) return;
      t = d.createElement(e);t.async = !0;t.src = v;t.id = id;
