            ...
            @foreach ($available_customers as $customer)
                <tr>
                    ...
                    <td>
                        ...
                        @if (count($customer->rincian_transaksi) > 0)
                        {{ Form::button('Detail order', ['name'=>'btn_edit','class'=>'btn btn-info btn-sm ','data-order'=>$customer->rincian_transaksi,'data-toggle'=>'modal','data-target'=>'#rincian_order']) }}
                        @endif
                    </td>
